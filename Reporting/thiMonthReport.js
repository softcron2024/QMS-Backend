...
const thisMonthReport = asyncHandler(async (req, res) => {
    Connection.query("CALL SPthismonthreport()", (error, results) => {
        if (error) {
            let message = "Error getting tokens, Try Again!!!";
            let responseCode = 0;
...
module.exports = { thisMonthReport }