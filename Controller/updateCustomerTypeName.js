...
const updateCustomerType = asyncHandler(async (req, res) => {
    ...
    const { customer_type_id, customer_type_name, customer_type_color, customer_type_text_color, customer_type_priority } = req.body
    ...
    Connection.query("CALL SPupdatecustomertype(?, ?, ?, ?, ?)", [customer_type_id, customer_type_name, customer_type_color, customer_type_text_color, customer_type_priority], (error, results) => {
        if (error) {
            let message = "Error updating customer type, Try Again!!!";
            let responseCode = 0;
